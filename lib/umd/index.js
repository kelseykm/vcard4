(function (global, factory) {
  ...
  var _validate$19 = /*#__PURE__*/new WeakSet();
  var _cleanUp$1 = /*#__PURE__*/new WeakSet();
  var _cleanUpXML$1 = /*#__PURE__*/new WeakSet();
  var TextType = /*#__PURE__*/function (_BaseValue) {
    ...
    function TextType(_textValue2) {
      ...
      _classPrivateMethodInitSpec(_assertThisInitialized(_this), _cleanUpXML$1);
      _classPrivateMethodInitSpec(_assertThisInitialized(_this), _cleanUp$1);
      _classPrivateMethodInitSpec(_assertThisInitialized(_this), _validate$19);
      _classPrivateFieldInitSpec(_assertThisInitialized(_this), _textValue, {
        writable: true,
        value: void 0
      });
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$19, _validate2$19).call(_assertThisInitialized(_this), _textValue2);
    ...
    _createClass(TextType, [{
      key: "value",
      get: function get() {
        return _classPrivateMethodGet(this, _cleanUp$1, _cleanUp2$1).call(this, _classPrivateFieldGet(this, _textValue));
      }
    }, {
      key: "valueXML",
      get: function get() {
        return "<".concat(this.constructor.type.toLowerCase(), ">").concat(_classPrivateMethodGet(this, _cleanUpXML$1, _cleanUpXML2$1).call(this, _classPrivateFieldGet(this, _textValue)), "</").concat(this.constructor.type.toLowerCase(), ">");
      }
    }, {
      key: "valueJSON",
      get: function get() {
  ...
  function _validate2$19(textValue) {
  ...
  var TextListType = /*#__PURE__*/function (_BaseValue) {
    ...
    function TextListType(_textlist2) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$18, _validate2$18).call(_assertThisInitialized(_this), _textlist2);
  ...
  function _validate2$18(textlist) {
  ...
  var BooleanType = /*#__PURE__*/function (_BaseValue) {
    ...
    function BooleanType(_boolValue2) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$17, _validate2$17).call(_assertThisInitialized(_this), _boolValue2);
  ...
  function _validate2$17(boolValue) {
  ...
  var DateTimeType = /*#__PURE__*/function (_BaseValue) {
    ...
    function DateTimeType(_type, _dateTimeValue2) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validateAndSetType, _validateAndSetType2).call(_assertThisInitialized(_this), _type, _dateTimeValue2);
  ...
  function _validateAndSetType2(type, dateTimeValue) {
  ...
  var DateTimeListType = /*#__PURE__*/function (_BaseValue) {
    ...
    function DateTimeListType(_datetimelist2) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$16, _validate2$16).call(_assertThisInitialized(_this), _datetimelist2);
  ...
  function _validate2$16(datetimelist) {
  ...
  var IntegerType = /*#__PURE__*/function (_BaseValue) {
    ...
    function IntegerType(_intValue2) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$15, _validate2$15).call(_assertThisInitialized(_this), _intValue2);
  ...
  function _validate2$15(intValue) {
  ...
  var IntegerListType = /*#__PURE__*/function (_BaseValue) {
    ...
    function IntegerListType(_integerlist2) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$14, _validate2$14).call(_assertThisInitialized(_this), _integerlist2);
  ...
  function _validate2$14(integerlist) {
  ...
  var FloatType = /*#__PURE__*/function (_BaseValue) {
    ...
    function FloatType(_floatValue2) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$13, _validate2$13).call(_assertThisInitialized(_this), _floatValue2);
  ...
  function _validate2$13(floatValue) {
  ...
  var FloatListType = /*#__PURE__*/function (_BaseValue) {
    ...
    function FloatListType(_floatlist2) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$12, _validate2$12).call(_assertThisInitialized(_this), _floatlist2);
  ...
  function _validate2$12(floatlist) {
  ...
  var LanguageTagType = /*#__PURE__*/function (_BaseValue) {
    ...
    function LanguageTagType(_langTagValue2) {
      ...
      _classPrivateFieldInitSpec(_assertThisInitialized(_this), _langTagRegexp, {
        writable: true,
        value: /^(?:[a-zA-Z]{2,3}(-[a-zA-Z]{3}){0,3})(-[0-9A-Za-z]+){0,3}(-x(-[0-9A-Za-z]{1,8})+)?(-[0-9A-WY-Za-wy-z]+)?(-[0-9A-Za-z]+)?$/
      });
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$11, _validate2$11).call(_assertThisInitialized(_this), _langTagValue2);
  ...
  function _validate2$11(langTagValue) {
    if (typeof langTagValue === "undefined") throw new MissingArgument("Value for LanguageTagType must be supplied");else if (typeof langTagValue !== "string") throw new TypeError("Value for LanguageTagType should be of type string");else if (!_classPrivateFieldGet(this, _langTagRegexp).test(langTagValue)) throw new InvalidArgument("Invalid language tag");
  }
  ...
  var URIType = /*#__PURE__*/function (_BaseValue) {
    ...
    function URIType(_uriValue2) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$10, _validate2$10).call(_assertThisInitialized(_this), _uriValue2);
  ...
  function _validate2$10(uriValue) {
  ...
  var SpecialValueType = /*#__PURE__*/function (_BaseValue) {
    ...
    function SpecialValueType(_targetProp, _value) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validateAndSet, _validateAndSet2).call(_assertThisInitialized(_this), _targetProp, _value);
  ...
  function _validateAndSet2(targetProp, value) {
    var _value$, _value$2;
  ...
  var ParameterValueType = /*#__PURE__*/function (_BaseValue) {
    ...
    function ParameterValueType(_parameterValue2) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$_, _validate2$_).call(_assertThisInitialized(_this), _parameterValue2);
  ...
  function _validate2$_(parameterValue) {
  ...
  var TypeParameter = /*#__PURE__*/function (_BaseParameter) {
    ...
    function TypeParameter(_targetProp, _typeValue2) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$U, _validate2$U).call(_assertThisInitialized(_this), _targetProp, _typeValue2);
  ...
  function _validate2$U(targetProp, typeValue) {
    var _this2 = this;
  ...
  var MediatypeParameter = /*#__PURE__*/function (_BaseParameter) {
    ...
    _createClass(MediatypeParameter, [{
      key: "value",
      get: function get() {
        return Array.isArray(_classPrivateFieldGet(this, _mediaValue)) ? "\"".concat(_classPrivateFieldGet(this, _mediaValue).map(function (val) {
          return val.repr();
      ...
      key: "valueXML",
      get: function get() {
        return Array.isArray(_classPrivateFieldGet(this, _mediaValue)) ? "<text>" + _classPrivateFieldGet(this, _mediaValue).map(function (val) {
          return val.reprXML();
      ...
      key: "valueJSON",
      get: function get() {
        if (Array.isArray(_classPrivateFieldGet(this, _mediaValue))) return ["text", _classPrivateFieldGet(this, _mediaValue).map(function (val) {
          return val._unsafe_raw_value;
        }).join(";")];
  ...
  function _validate2$T(mediaValue) {
    if (typeof mediaValue === "undefined") throw new MissingArgument("Value for MediatypeParameter must be supplied");else if (!Array.isArray(mediaValue) && mediaValue.constructor.identifier !== "ParameterValueType" || Array.isArray(mediaValue) && !mediaValue.every(function (val) {
      return val.constructor.identifier === "ParameterValueType";
    })) throw new TypeError("Value for MediatypeParameter must be of ParameterValueType or an array of ParameterValueTypes");else if (!Array.isArray(mediaValue) && !_classPrivateFieldGet(this, _mediaTypeRegExp).test(mediaValue.repr())) throw new InvalidArgument("Invalid media type");else if (Array.isArray(mediaValue)) {
  ...
  var LevelParameter = /*#__PURE__*/function (_BaseParameter) {
    ...
    function LevelParameter(_targetProp, _levelValue2) {
      ...
      _classPrivateMethodGet(_assertThisInitialized(_this), _validate$K, _validate2$K).call(_assertThisInitialized(_this), _targetProp, _levelValue2);
  ...
  function _validate2$K(targetProp, levelValue) {
  ...
  var Group = /*#__PURE__*/function () {
    ...
    _createClass(Group, [{
      ...
      key: "properties",
      get: function get() {
        return _classPrivateFieldGet(this, _props$1);
      }
    }, {
      key: "repr",
      value: function repr() {
  ...
  function _parametersSeparator2(params) {
    ...
    for (var _index6 = 0; _index6 < paramList.length; _index6++) {
      ...
      if (holdCurrentParamValue.startsWith('"') && holdCurrentParamValue.endsWith('"') && !_classPrivateFieldGet(this, _uriRegExp).test(holdCurrentParamValue.slice(1, -1))) holdCurrentParamValue = _classPrivateMethodGet(this, _valueSeparator, _valueSeparator2).call(this, holdCurrentParamValue.slice(1, -1));else if (holdCurrentParamValue.startsWith('"') && holdCurrentParamValue.endsWith('"')) holdCurrentParamValue = holdCurrentParamValue.slice(1, -1);
