...
var TypeParameter = /*#__PURE__*/function (_BaseParameter) {
  ...
  function TypeParameter(_targetProp, _typeValue2) {
    ...
    _classPrivateMethodGet(_assertThisInitialized(_this), _validate, _validate2).call(_assertThisInitialized(_this), _targetProp, _typeValue2);
...
function _validate2(targetProp, typeValue) {
  var _this2 = this;
