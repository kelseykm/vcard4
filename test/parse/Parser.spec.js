  ...
  it("Parses vcards correctly", () => {
    ...
    assert.deepEqual(parsedVcard2.parsed.getGroup("story"), [
      ...
      },
      {
        ...
        parameters: {},
        value:
          "John Doe has a long and varied history, being documented on more police files than anyone else. Reports of his death are alas numerous.",
      },
    ]);
  });
});
