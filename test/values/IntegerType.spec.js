...
describe("IntegerType tests", () => {
  ...
  it("Formats value properly", () => {
    assert.strictEqual(new IntegerType(30).repr(), "30");
    assert.strictEqual(new IntegerType(30).reprXML(), "<integer>30</integer>");
    assert.deepEqual(new IntegerType(30).reprJSON(), ["integer", 30]);
  });
});
