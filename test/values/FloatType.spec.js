...
describe("FloatType tests", () => {
  ...
  it("Formats value properly", () => {
    assert.strictEqual(new FloatType(30.45).repr(), "30.45");
    assert.strictEqual(new FloatType(30.45).reprXML(), "<float>30.45</float>");
    assert.deepEqual(new FloatType(30.45).reprJSON(), ["float", 30.45]);
  });
});
